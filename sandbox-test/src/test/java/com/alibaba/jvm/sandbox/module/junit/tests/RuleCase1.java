...
public class RuleCase1 {
    ...
    @Test
    @PrepareForTest(testModule = DummyModule.class, fastMode = false)
    public void testcase2() throws ServletException, IOException {

        when(request.getHeader("username")).thenReturn("test");
        ...
        assertThat(result, containsString("login user: test"));
    }
